...
import { LogIn, User as UserIcon, Lock, UserPlus, AlertCircle } from 'lucide-react'
  ...
  useEffect(() => {
    ...
    if (errorParam) {
      const errorMessages: Record<string, string> = {
        ...
        'email_exists': 'This email is already registered with a different sign-in method.',
